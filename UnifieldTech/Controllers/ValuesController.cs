...
namespace UnifieldTech.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        public ValuesController(IConfiguration configuration, IAuthenticate authentication)
        {
        ...
        [HttpPost("LoginUser")]
        public async Task<ActionResult<UserToken>> LoginUser([FromBody] Login userInfo)
        {
